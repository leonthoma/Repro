...
* Only relevant drivers of decline could potentially only alter behavior, not abundance of insects
...
```{r, echo=FALSE, out.width="90%", fig.cap="Headline of an online magazine"}
knitr::include_graphics("cit_science.JPG")
```
