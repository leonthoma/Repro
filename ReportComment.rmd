...
* (Why is there a need for more research in this area) Control Group suggestion?? How could this be done? --> RTM also appears as a selection phenomenon, emphasizing the need to include control groups in order to make possible adjustments for the bias caused by RTM. [@Blomqvist1987]
